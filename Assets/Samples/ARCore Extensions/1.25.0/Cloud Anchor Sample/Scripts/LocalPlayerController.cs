...
#pragma warning restore 618
    {
        ...
        public void SpawnAnchor(ARAnchor anchor)
        {
            ...
            var StarObject = Instantiate(StarPrefab, Vector3.zero, Quaternion.identity);

            // Anchor must be hosted in the device.
            StarObject.GetComponent<AnchorController>().HostAnchor(anchor);
...
#pragma warning restore 618
        public void CmdSpawnStar(Vector3 position, Quaternion rotation)
        {
            ...
            AnchorObject.GetComponent<StarController>().SetParentToWorldOrigin();
